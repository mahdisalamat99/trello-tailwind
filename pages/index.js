export default function Home() {
  return (
    <div className="relative">
      <header className="w-full h-16 flex flex-row justify-between absolute top-0 left-0 z-10">
        <nav className="w-full h-16  shadow-lg flex flex-row justify-between p-4" >

        <div className="w-40 h-full bg-white-500 hover:cursor-pointer">
          <svg
              role="img"
              alt="Trello"
              height="36"
        ...
        <div className="h-full flex flex-row gap-4 text-lg">
          <button className="text-blue-500 hover:underline leading-none" >Log in</button>
          <button className="bg-blue-500 hover:bg-blue-700 text-white px-2 rounded-md leading-none" >Sign up</button>
        </div>
        </nav>
      </header>
      <main className="h-screen bg-gradient-to-b from-purple-200 flex flex-row items-center" >
        <div className="w-7/12 flex flex-row-reverse px-52 pl-52">
          <div>
            ...
            <div className="flex flex-row w-full gap-2 h-12">
              <input type="text" placeholder="Email" className="w-7/12 px-4 h-full" ></input>
              <button className="w-5/12 h-full text-white text-2xl  bg-blue-700 rounded-md flex justify-center leading-none items-center" >Sign up--it's free</button>
            </div>
          </div>
        </div>
